...
const VARIANT_CLASSES: Record<Variant, string> = {
  primary: "bg-accent text-accentInk shadow-soft hover:bg-accent/90 hover:-translate-y-px disabled:bg-accent/50 disabled:shadow-none disabled:translate-y-0",
